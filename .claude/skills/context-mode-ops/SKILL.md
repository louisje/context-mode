...
npx skills add louisje/context-mode --skill context-mode-ops

# Or install all context-mode skills
npx skills add louisje/context-mode

# Or direct path
npx skills add https://github.com/louisje/context-mode/tree/main/skills/context-mode-ops
```
